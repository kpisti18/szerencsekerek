...
// <<< A forgási időt a const duration változónál tudod állítani (197. sor)

let slices = basePrizes.flatMap(p => [p, "nem nyert"]);
...
function startSpin() {
    ...
    const duration = 4200 + Math.random() * 1200; // 4200 alap forgási idő (4,2s), és (Math.random()*1200) véletlenszerűen 0-1.2 másodpercet hozzáadunk, hogy ne mindig ugyanannyi legyen
...
modal.addEventListener("click", (e) => {
    // ne záródjon be ha a bezáró gombot nyomod,
    // mert arra külön eventListener van
